...
EXISTENCE_REPO_URL="${REPOSITORY_URL}${VERSION_PYTHON_MAJOR}.${VERSION_PYTHON_MINOR}-${EXISTENCE_TAG}";
PYTHON_VERSION_REPO_URL="${REPOSITORY_URL}${VERSION_PYTHON_MAJOR}.${VERSION_PYTHON_MINOR}";

LATEST_REPO_URL="${REPOSITORY_URL}${VERSION_PYTHON_MAJOR}.${VERSION_PYTHON_MINOR}-latest";
